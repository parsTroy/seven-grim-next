...
export const metadata: Metadata = {
  title: "About Us - 7Grim Studio",
  description: "Learn about 7Grim Studio, our mission, team, and vision for the future of gaming.",
};
      ...
      <div className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              <h2 className="font-gaming text-3xl md:text-4xl text-gradient mb-6">
                OUR MISSION
              </h2>
              <div className="space-y-4 text-gray-300">
                <p>
                  At 7Grim Studio, we believe games are more than entertainment—they&apos;re 
                  gateways to new worlds, catalysts for connection, and platforms for 
                  innovation. Our mission is to create experiences that challenge, 
                  inspire, and transform players.
                </p>
                <p>
                  We&apos;re committed to pushing technological boundaries while maintaining 
                  the heart and soul that makes gaming magical. Every project is an 
                  opportunity to redefine what&apos;s possible in interactive media.
                </p>
              </div>
            </div>
          ...
          <div className="text-center">
            <h2 className="font-gaming text-3xl md:text-4xl text-gradient mb-12">
              OUR VALUES
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="card-gaming">
                ...
                <h3 className="font-gaming text-xl text-gradient mb-3">INNOVATION</h3>
                <p className="text-gray-400">
                  We constantly push technological boundaries and explore new creative possibilities.
                </p>
              </div>
              <div className="card-gaming">
                <div className="w-16 h-16 bg-gradient-to-r from-orange-500 to-red-500 rounded-full mx-auto mb-4 flex items-center justify-center">
                ...
                <h3 className="font-gaming text-xl text-gradient mb-3">QUALITY</h3>
                <p className="text-gray-400">
              ...
              <div className="card-gaming">
                ...
                <h3 className="font-gaming text-xl text-gradient mb-3">COLLABORATION</h3>
                <p className="text-gray-400">
